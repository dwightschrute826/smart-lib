 ...
 * @author Hydron
 */
public class BDelete extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 80, 130, 32));

        borid.setFont(new java.awt.Font("Rockwell", 0, 18)); // NOI18N
        jPanel1.add(borid, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 80, 201, 32));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        { 
           String ID = borid.getText();
           Connection con = connect.dbconnection();
           Statement st = con.createStatement();
           ResultSet rs = st.executeQuery("select * from borrowers where BOR_ID = '"+ID+"'");
           if(rs.next())
           {
                String sql = "delete from borrowers where BOR_ID ='"+ID+"'";
                st.executeUpdate(sql);
                JOptionPane.showMessageDialog(this,"Borrower record deletion Successful !","Success",JOptionPane.INFORMATION_MESSAGE);
                borid.setText("");}
                else
                {
                    JOptionPane.showMessageDialog(this,"Record of borrower with ID " + ID + " does not exist !","ERROR",JOptionPane.INFORMATION_MESSAGE);
                }
        }
        catch(Exception e)
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BDelete.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
